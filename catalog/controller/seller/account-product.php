...
class ControllerSellerAccountProduct extends ControllerSellerAccount {
    ...
    public function jxSubmitProduct() {
        ...
        if (isset($data['categories']) && !empty($data['categories'])) {
            //commented for replacing existing category structure with new
...
//        pr($this->data);die;
    ...
    public function update() {
        ...
        if (isset($product['shipping']) && $product['shipping'] == 1 && $this->config->get('msconf_enable_quantities') == 2)
            $this->data['enable_quantities'] = 1;
